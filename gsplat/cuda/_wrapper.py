...
@torch.no_grad()
def rasterize_to_trans_in_range(
    range_start: int,
    range_end: int,
    transmittances: Tensor,  # [C, image_height, image_width]
    means2d: Tensor,  # [C, N, 2]
    ...
    out_gauss_ids, out_indices, total_transmittances, total_counts = _make_lazy_cuda_func("rasterize_to_trans_in_range")(
        range_start,
        range_end,
        transmittances.contiguous(),
        means2d.contiguous(),
    ...
    out_pixel_ids = out_indices % (image_width * image_height)
    out_camera_ids = out_indices // (image_width * image_height)
    return out_gauss_ids, out_pixel_ids, out_camera_ids, total_transmittances, total_counts
